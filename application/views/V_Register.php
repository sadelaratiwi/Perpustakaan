...
<head>
	...
	<title>Daftar Member - Perpustakaan Digital</title>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="bradcaump__inner text-center">
                        	<h2 class="bradcaump-title">Daftar member</h2>
                            <nav class="bradcaump-content">
                              <a class="breadcrumb_item" href="<?=base_url();?>">Beranda</a>
                              <span class="brd-separetor">/</span>
                              <span class="breadcrumb_item active">Daftar member</span>
                            </nav>
                        </div>
                    </div>
                </div>
				...
				<div class="row">
					<div class="col-lg-12 col-12">
						<div class="my__account__wrapper">
							<h3 class="account__title">Daftar Member</h3>
							<?=form_open('register', array('method'=>'post'));?>
								<div class="account__form">
					              ...
					              <?php } ?>
									...
									<div class="input__box">
										...
										<select name="jenis_kelamin" class="select__option" id="jenis_kelamin">
									...
									<div class="input__box">
										...
										<input type="text" id="tgl_lahir" name="tgl_lahir" class="datepicker" data-date-format="yyyy-mm-dd">
									</div>
									<div class="form__btn">
