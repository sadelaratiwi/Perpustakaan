...
<head>
	...
	<title>Data Member - Perpustakaan Digital</title>
	...
	<link rel="stylesheet" type="text/css" href="<?=assets_uri('DataTables/datatables.min.css');?>"/>
...
<body>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="bradcaump__inner text-center">
                        	<h2 class="bradcaump-title">Data member</h2>
                        </div>
                    </div>
                </div>
            </div>
				...
				<div class="row">
					<div class="col-lg-12 col-12">
						<div class="my__account__wrapper">
							<h3 class="account__title">Data member</h3>
	...
	<script src="<?=assets_uri('DataTables/datatables.min.js');?>"></script>
	...
	<script type="text/javascript">
		base_url="<?=base_url();?>";
		function data_member_load() {
		    $('table.data').DataTable({
		        ajax: {
		            url: base_url + 'admin/data_member_ajax',
		        },
		        columns: [{
		                title: "No.",
		                data: 'id'
		        ...
		        createdRow: function(row, data, index) {
		            ...
		            if (data['id']) {
		                var id = data['id'],
		                    html = '';
	                    html += '<button type="button" onclick="javascript:top.location.href=\'' + base_url + 'admin/verif_member/' + id + '\';" class="btn btn-info btn-icons btn-rounded">Verifikasi</button>';
